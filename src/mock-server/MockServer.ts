...
class MockServerClass {
    ...
    if (saved) {
      try {
        ...
        if (
          ...
          !this.db.events ||
          !this.db.events.some((e) => e.id === 108) ||
          !this.db.notifications ||
          !this.db.notifications.some((n) => n.id === 1003)
        ) {
          this.seed();
        } else {
  ...
  private seed() {
    this.db.homework = seedHomework.map((h) => ({
      ...h,
      description:
        "Solve the equations and upload the PDF file containing your worked steps.",
    ...
    this.db.events = [
      {
        ...
        coverImage:
          "https://images.unsplash.com/photo-1526976668912-1a811878dd37?q=80&w=1200",
        description:
        ...
        instructions:
          "Students should bring comfortable sports gear, water bottles, and school ID. Lunch and refreshments provided daily.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Master Python programming, build smart chatbots, neural networks, and explore machine learning models with hands-on projects and industry mentorship.",
        highlights: [
        ...
        instructions:
          "Workstations with pre-configured Python environments will be provided. Bringing your own laptop is optional.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "EduVerse Annual Merit Scholarship Test offers tuition fee waivers up to 100% for top performing students in Grade 8 to 12.",
        highlights: [
        ...
        instructions:
          "Reporting time is 08:30 AM. Carry printed admit slip and transparent geometry pouch.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Get deep discounts on official STEM reference guides, solved past papers, lab manuals, and digital learning subscriptions.",
        highlights: [
        ...
        maxSeats: 1000,
        registrationDeadline: "2026-09-20T17:00:00",
        fee: 0,
        paymentRequired: false,
        ...
        instructions:
          "Digital invoice will be delivered via EduVerse app. Physical store open till 5 PM.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Compete in track & field sprints, relay races, football, basketball, and table tennis. Showcase your athletic talent and win gold medals!",
        highlights: [
        ...
        instructions:
          "All participants must wear official house jerseys and athletic footwear.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Present your working hardware prototypes, IoT devices, automated bots, and green energy innovations to distinguished industry judges.",
        highlights: [
        ...
        maxSeats: 100,
        registrationDeadline: "2026-09-26T23:59:59",
        fee: 100,
        paymentRequired: true,
        ...
        instructions:
          "Setup starts at 08:30 AM. Power sockets and Wi-Fi access will be provided per booth.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Team up with fellow student developers, code innovative solutions for real community challenges, and win cash prizes worth ₹50,000!",
        highlights: [
        ...
        maxSeats: 60,
        registrationDeadline: "2026-10-07T23:59:59",
        fee: 250,
        paymentRequired: true,
        ...
        instructions:
          "Teams of up to 3 members allowed. Starter codebase repositories will be provided on GitHub.",
        status: "published",
        registered: false,
      },
      {
        ...
        description:
          "Express your artistic soul! Audition for live acoustic band performances, solo singing, digital painting, and street drama competitions.",
        highlights: [
        ...
        maxSeats: 250,
        registrationDeadline: "2026-10-16T18:00:00",
        fee: 0,
        paymentRequired: false,
        ...
        instructions:
          "Musicians may bring their own instruments. Sound check opens at 12:00 PM.",
        status: "published",
        registered: false,
      },
    ];
    ...
    this.db.notifications = [
      {
        id: 1001,
        title: "Calculus homework assignment",
        description:
          "Calculus Exercises 1-20 is due today. Please submit in learn workspace.",
        time: "1 hr ago",
        read: false,
        type: "homework",
      },
  ...
  publishHomework(
    hw: Omit<HomeworkItem, "id" | "status" | "submissions" | "attachments">,
  ) {
    ...
    return new Promise<Registration>((resolve) => {
      setTimeout(() => {
        const cleanStudentId =
          studentId === "sarah" || studentId === "GFA-2025-10042"
            ? "GFA-2025-10042"
            : studentId;
        const regIndex = this.db.registrations.findIndex(
          (r) => r.eventId === eventId && r.studentId === cleanStudentId,
        );
        ...
        const ticketNum =
          "TKT-" + eventId + "-" + Math.floor(Math.random() * 9000 + 1000);
        ...
        const eventTitle =
          this.db.events.find((e) => e.id === eventId)?.title || "Event";
        this.createNotification(
  ...
  getRegistrations(eventId?: number) {
    if (eventId) {
      return Promise.resolve(
        this.db.registrations.filter((r) => r.eventId === eventId),
      );
    }
  ...
  getStudentRegistrations(studentId: string) {
    const cleanStudentId =
      studentId === "sarah" || studentId === "GFA-2025-10042"
        ...
        : studentId;
    return Promise.resolve(
      this.db.registrations.filter((r) => r.studentId === cleanStudentId),
    );
  }
