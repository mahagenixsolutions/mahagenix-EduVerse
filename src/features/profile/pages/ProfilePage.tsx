        ...
        <div className={styles.heroMainSection}>
          ...
          <div className={styles.heroDetails}>
            <div className={styles.nameRow}>
              ...
              <span className={styles.statusPill}>Parent</span>
            </div>
            <p className={styles.classSubtitle}>{currentUser?.details}</p>
            <div
      ...
      <div className={styles.profileGrid}>
        <Card className={styles.profileCard}>
          <div className={styles.cardHeader}>
            <p className={styles.cardTitle}>Child Information</p>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <Avatar src={child.avatar} alt={child.name} size="lg" />
            <div>
              <p
